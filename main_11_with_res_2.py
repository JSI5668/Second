...
def get_argparser():
    ...
    parser.add_argument("--ckpt_pre", default='E:/Second_paper/Checkpoint/Camvid/Blur_firstfold/main_11_with_res_MHNet_my_2/model_pre_best_deeplabv3plus_resnet50_camvid_MHNet_withresto_os16.pth', type=str,
...
def get_dataset(opts):
    ...
    if opts.dataset == 'camvid_MHNet_withresto':
        ...
        train_dst = get_training_data('E:/Second_paper/Data/CamVid/Blurred/Firstfold/For_Segmentation_With_Resto/train', {'patch_size':opts.crop_size})

        val_dst = get_validation_data('E:/Second_paper/Data/CamVid/Blurred/Firstfold/For_Segmentation_With_Resto/test', {'patch_size':opts.crop_size})

        test_dst = get_validation_data('E:/Second_paper/Data/CamVid/Blurred/Firstfold/For_Segmentation_With_Resto/test', {'patch_size':opts.crop_size})
...
####################resto#################################
    ...
    checkpoint = torch.load('E:/Second_paper/Checkpoint/Camvid/Original_firstfold/main_10_UNetmy_2_Edge_perceptual_lr_0.0001_0,1,0_1000epo/best_deeplabv3plus_resnet50_camvid_sample_os16.pth')
    ...
    if opts.test_only:
        ...
        val_score, ret_samples = validate_With_resto(
            opts=opts, model1=model_pre, model2=model, loader=val_loader_resto, device=device, metrics=metrics, ret_samples_ids=vis_sample_id)
...
######### last checkpoint 받아서 이어서 학습 ##############
        ...
        while True: #cur_itrs < opts.total_itrs:
            ...
            for resto_target, blurred, semantic_target in train_loader_resto:
                ...
                loss_resto = criterion_mse(outputs_pre, target)
                loss_resto.backward()
                optimizer_pre.step()
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    train_val_score, ret_samples = validate_With_resto(
                        opts=opts, model1=model_pre, model2=model, loader=train_loader_resto, device=device, metrics=metrics,
                ...
                if (cur_itrs) % opts.val_interval == 0:
                    ...
                    if val_score['Mean IoU'] > best_score:  # save best model
                        ...
                        save_ckpt('E:/Second_paper/Checkpoint/Camvid/Blur_firstfold/main_11_with_res_MHNet_my_2/best_%s_%s_os%d.pth' %
                                  (opts.model, opts.dataset, opts.output_stride))
                        save_ckpt_pre('E:/Second_paper/Checkpoint/Camvid/Blur_firstfold/main_11_with_res_MHNet_my_2/model_pre_best_%s_%s_os%d.pth' %
                                  (opts.model, opts.dataset, opts.output_stride))
                ...
                if cur_itrs >= opts.total_itrs:
                    ...
                    df_train_miou.to_csv('E:/Second_paper/Checkpoint/Camvid/Blur_firstfold/main_11_with_res_MHNet_my_2/train_miou_2.csv', index=False)
                    df_train_loss.to_csv('E:/Second_paper/Checkpoint/Camvid/Blur_firstfold/main_11_with_res_MHNet_my_2/train_loss_2.csv', index=False)
