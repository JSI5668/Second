...
from datasets import VOCSegmentation, Cityscapes, Camvid, Camvid_60,  Camvid_sample, Camvid_focus, Kitti_sample, Camvid_proposed
...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='kitti_sample',
                        choices=['voc', 'cityscapes, camvid', 'camvid_sample', 'camvid_focus', 'kitti_sample', 'camvid_proposed'], help='Name of dataset')
    ...
    parser.add_argument("--ckpt", default='D:/checkpoint/Segmentation/kitti/original/firstfold/best_deeplabv3plus_resnet50_kitti_sample_os16.pth', type=str,
                        help="restore from checkpoint")
    # parser.add_argument("--ckpt",
    #                     default='D:/checkpoint/Segmentation/kitti/original/secondfold/kitti/best_deeplabv3plus_resnet50_kitti_sample_os16.pth',
    #                     type=str,
    #                     help="restore from checkpoint")
    ...
    #                     help="restore from checkpoint")
    # parser.add_argument("--ckpt",
    #                     default='E:/Second_paper/Checkpoint/Camvid/Original_firstfold/main_4/best_deeplabv3plus_resnet50_camvid_sample_os16.pth',
    #                     type=str,
    #                     help="restore from checkpoint")
