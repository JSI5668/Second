...
from datasets import VOCSegmentation, Cityscapes, Camvid, Camvid_60,  Camvid_sample, Camvid_focus, Kitti_sample
...
def get_argparser():
    ...
    parser.add_argument("--data_root", type=str, default='D:/Dataset/Jetson/kitti/restored_kitti',
...
def main():
    ...
    if opts.test_only:
        ...
        val_score, ret_samples = validate(
            opts=opts, model=model, loader=val_loader, device=device, metrics=None, ret_samples_ids=vis_sample_id)
        print(metrics.to_str(val_score))
        # PATH = 'C:/checkpoint_void/pytorch/segmentation/camvid_original_model_2/'
        # torch.save(model, PATH + 'model.pt' )
        return
