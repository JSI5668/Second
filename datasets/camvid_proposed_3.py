...
class Camvid_proposed_each_0(data.Dataset):
    ...
    **Parameters:**
    ...
    classes = [
        ...
        CamvidClass('pole', 2, 2, 'pole', 2, False, False, (0, 0, 0)),
        CamvidClass('road', 3, 3, 'road', 3, False, False, (128, 64, 128)),
        CamvidClass('sidewalk', 2, 2, 'sidewalk', 4, False, False, (0, 0, 0)),
        CamvidClass('tree', 2, 2, 'tree', 5, False, False, (0, 0, 0)),
        CamvidClass('signsymbol', 2, 2, 'signsymbol', 6, False, False, (0, 0, 0)),
        CamvidClass('fence', 2, 2, 'fence', 7, False, False, (0, 0, 0)),
        CamvidClass('car', 2, 2, 'car', 8, False, False, (0, 0, 0)),
        CamvidClass('pedestrian', 2, 2, 'pedestrian', 9, False, False, (0, 0, 0)),
        CamvidClass('bicyclist', 2, 2, 'bicyclist', 10, False, False, (0, 0, 0)),
