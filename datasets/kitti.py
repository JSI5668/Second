...
class Kitti_sample(data.Dataset):
    ...
    **Parameters:**
    ...
    classes = [
        ...
        CamvidClass('road', 2, 2, 'pole', 2, False, False, (128, 64, 128)),
        CamvidClass('sidewalk', 3, 3, 'road', 3, False, False, (0, 0, 192)),
        CamvidClass('fence', 4, 4, 'sidewalk', 4, False, False, (64, 64, 128)),
        CamvidClass('tree', 5, 5, 'tree', 5, False, False, (128, 128, 0)),
        CamvidClass('pole', 6, 6, 'signsymbol', 6, False, False, (192, 192, 128)),
        CamvidClass('car', 7, 7, 'fence', 7, False, False, (64, 0, 128)),
        CamvidClass('sign', 8, 8, 'car', 8, False, False, (192, 128, 128)),
    ...
    #
    #     return image, target, image_original.__array__()
