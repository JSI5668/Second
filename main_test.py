...
def get_argparser():
    ...
    # parser.add_argument("--ckpt", default='E:/Second_paper/Checkpoint/Camvid/Original_firstfold/Only_UNet_12class/best_deeplabv3plus_resnet50_camvid_sample_os16.pth',
    ...
    #                     default='D:/checkpoint/Segmentation/kitti/original/firstfold/best_deeplabv3plus_resnet50_kitti_sample_os16.pth',type=str,
    #                     help="restore from checkpoint")
...
def main():
    ...
    if opts.ckpt is not None and opts.test_only:
        ...
        # PATH_1 = 'D:/checkpoint/Segmentation/kitti/original/firstfold_model/model.pt'
